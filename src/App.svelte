...
<style>
	@import url('https://fonts.googleapis.com/css2?family=Merriweather:wght@300&family=Raleway&display=swap');
	...
	<section class="container">
		<div class="content">
			...
			<aside class="contact">
				<h4>Contact</h4>
				<ul>
					<li><a href="https://github.com/jamalmoir">Github</a></li>
					<li><a href="https://www.linkedin.com/in/jamal-moir-5295b28a/">Linkedin</a></li>
					<li><a href="mailto:jamal.moir@gmail.com">Email</a></li>
				</ul>
			</aside>
		</div>
	</section>
